...
cwd = os.getcwd()
sample_path = os.path.expanduser('rbs_alk_eltern_sample_ragllm_annotiert.xlsx')
...
psych_eltern_string = [ "Alkohol Erkankungen bei Eltern nicht erwähnt", "Alkohol Erkrankungen bei Eltern erwähnt"]
...
id2label={
    ...
    "0": "Alkohol Erkankungen bei Eltern nicht erwähnt",
    "1": "Alkohol Erkankungen bei Eltern erwähnt",    
  }

label2id={
    
    "Alkohol Erkankungen bei Eltern nicht erwähnt": 0,
    "Alkohol Erkankungen bei Eltern erwähnt": 1,    
  }, 
...
psych_eltern_string = [ "Alkohol Erkankungen bei Eltern nicht erwähnt", "Alkohol Erkankungen bei Eltern erwähnt"]
...
model.save_pretrained("alk_class_gelectra_rag", safe_serialization=True)
tokenizer.save_pretrained("alk_class_gelectra_rag")
