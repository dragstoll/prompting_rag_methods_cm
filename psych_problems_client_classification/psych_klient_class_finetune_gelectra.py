...
cwd = os.getcwd()
sample_path = os.path.expanduser('./rbs_psych_klient_sample501-1000mx22_annotiert.xlsx')
...
psych_eltern_string = [ "psychische Störungen/Erkankungen beim Kind nicht erwähnt", "psychische Störungen/Erkankungen beim Kind erwähnt"]
...
id2label={
    ...
    "0": "psychische Störungen/Erkankungen beim Kind nicht erwähnt",
    "1": "psychische Störungen/Erkankungen beim Kind erwähnt",    
  }

label2id={
    
    "psychische Störungen/Erkankungen beim Kind nicht erwähnt": 0,
    "psychische Störungen/Erkankungen beim Kind erwähnt": 1,    
  }, 
...
model.save_pretrained("./psych_klient_class_mx22", safe_serialization=True)
tokenizer.save_pretrained("./psych_klient_class_mx22")
