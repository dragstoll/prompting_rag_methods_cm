...
# sample_path = os.path.expanduser('rbs_sucht_eltern_sample_ragfaissrecsplit_annotiert2.xlsx')
...
# print(sample_df['code'].value_counts())
# sys.exit()
...
psych_eltern_string = [ "SuchtErkankungen bei Eltern nicht erwähnt", "SuchtErkrankungen bei Eltern erwähnt"]
