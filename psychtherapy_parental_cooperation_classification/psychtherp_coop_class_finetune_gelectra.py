...
cwd = os.getcwd()
sample_path = os.path.expanduser('./psychtherp_coop_sample_annotiert.xlsx')
...
test_data_label_1 = sample_df[sample_df['label'] == 1].sample(n=30, random_state=42)
...
psych_eltern_string = [ "Hinweise nicht vorhanden für mangelnde Zusammenarbeit für Therapien", "Hinweise vorhanden für mangelnde Zusammenarbeit für Therapien",]
...
id2label={
    ...
    "0": "Hinweise nicht vorhanden für mangelnde Zusammenarbeit für Therapien",
    "1": "Hinweise vorhanden für mangelnde Zusammenarbeit für Therapien",    
  }

label2id={
    
    "Hinweise nicht vorhanden für mangelnde Zusammenarbeit für Therapien": 0,
    "Hinweise vorhanden für mangelnde Zusammenarbeit für Therapien": 1,    
  }, 
...
training_args = TrainingArguments(output_dir='results_gelectra', 
                                  num_train_epochs=4, 
                                #   logging_steps=100, 
                                #   save_steps=100,
...
model.save_pretrained("./psychtherp_coop_class_mx22", safe_serialization=True)
tokenizer.save_pretrained("./psychtherp_coop_class_mx22")
