...
cwd = os.getcwd()
sample_path = os.path.expanduser('./housing_classification/rbs_housing_direkt_sample_antwort_annotiert.xlsx')
...
psych_eltern_string = [ "Hinweise nicht vorhanden für schwierige Wohn Situation", "Hinweise vorhanden für schwierige Wohn Situation",]
...
id2label={
    ...
    "0": "Hinweise nicht vorhanden für schwierige Wohn Situation",
    "1": "Hinweise vorhanden für schwierige Wohn Situation", 

  }

label2id={
    
    "Hinweise nicht vorhanden für schwierige Wohn Situation": 0,
    "Hinweise vorhanden für schwierige Wohn Situation": 1,    
...
training_args = TrainingArguments(output_dir='results_gelectra_housing_finetune', 
                                  num_train_epochs=4, 
                                #   logging_steps=100, 
                                #   save_steps=100,
...
model.save_pretrained("./housing_classification/housing_class_gelectra_direkt", safe_serialization=True)
tokenizer.save_pretrained("./housing_classification/housing_class_gelectra_direkt")
