...
# rbs_alk_eltern_sample.to_pickle('rbs_alk_eltern_sampleTemp.pkl')
# rbs_alk_eltern_sample.to_excel('rbs_alk_eltern_sampleTemp.xlsx')
# rbs_alk_eltern_sample0= pd.read_excel('rbs_alk_eltern_sampleTemp.xlsx', sheet_name='Sheet1')
# rbs_alk_eltern_sample0['extracted_context'] = rbs_alk_eltern_sample0['context'].apply(lambda x: extract_context(x))
# rbs_alk_eltern_sample0.to_excel('rbs_alk_eltern_sampleTemp.xlsx')
# rbs_alk_eltern_sample=rbs_alk_eltern_sample0.copy()



rbs_alk_eltern_sample=pd.read_pickle(iter+"rbs_alk_eltern_sampleTemp.pkl")    

file_path = iter + "rbs_alk_eltern_sampleTemp.pkl"
if os.path.exists(file_path):
  os.remove(file_path)

# rbs_alk_eltern_sample=pd.read_pickle(file_path)
