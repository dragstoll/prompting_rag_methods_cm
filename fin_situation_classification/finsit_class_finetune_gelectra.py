...
cwd = os.getcwd()
sample_path = os.path.expanduser('./fin_situation_classification/rbs_finsit_direkt_sample_antwort_annotiert.xlsx')
...
psych_eltern_string = [ "Hinweise nicht vorhanden für schwierige finanzielle Situation", "Hinweise vorhanden für schwierige finanzielle Situation",]
...
id2label={
    ...
    "0": "Hinweise nicht vorhanden für schwierige finanzielle Situation",
    "1": "Hinweise vorhanden für schwierige finanzielle Situation", 

  }

label2id={
    
    "Hinweise nicht vorhanden für schwierige finanzielle Situation": 0,
    "Hinweise vorhanden für schwierige finanzielle Situation": 1,    
...
training_args = TrainingArguments(output_dir='results_gelectra_finsit_finetune', 
                                  num_train_epochs=2, 
                                #   logging_steps=100, 
                                #   save_steps=100,
...
model.save_pretrained("./fin_situation_classification/finsit_class_gelectra_direkt", safe_serialization=True)
tokenizer.save_pretrained("./fin_situation_classification/finsit_class_gelectra_direkt")
