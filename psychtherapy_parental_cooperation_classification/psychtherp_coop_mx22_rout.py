...
# Set up bitsandbytes parameters for quantization
use_4bit = True
...
# Import additional libraries for document processing and text generation
import nest_asyncio
nest_asyncio.apply()
...
# Initialize LLM with the text generation pipeline
...
# Define helper functions for document processing
...
# Save final results to Excel and pickle files
