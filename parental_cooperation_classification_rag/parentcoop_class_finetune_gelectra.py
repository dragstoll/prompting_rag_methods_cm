...
cwd = os.getcwd()
sample_path = os.path.expanduser('./parental_cooperation_classification/rbs_parentcoop_direkt_sample_antwort_annotiert.xlsx')
...
psych_eltern_string = [ "Hinweise nicht vorhanden für mangelnde Zusammenarbeit der Eltern", "Hinweise vorhanden für mangelnde Zusammenarbeit der Eltern",]
...
id2label={
    ...
    "0": "Hinweise nicht vorhanden für mangelnde Zusammenarbeit der Eltern",
    "1": "Hinweise vorhanden für mangelnde Zusammenarbeit der Eltern", 

  }

label2id={
    
    "Hinweise nicht vorhanden für mangelnde Zusammenarbeit der Eltern": 0,
    "Hinweise vorhanden für mangelnde Zusammenarbeit der Eltern": 1,    
...
training_args = TrainingArguments(output_dir='results_gelectra_parentcoop_finetune', 
                                  num_train_epochs=2, 
                                #   logging_steps=100, 
                                #   save_steps=100,
...
model.save_pretrained("./parental_cooperation_classification/parentcoop_class_gelectra_direkt", safe_serialization=True)
tokenizer.save_pretrained("./parental_cooperation_classification/parentcoop_class_gelectra_direkt")
