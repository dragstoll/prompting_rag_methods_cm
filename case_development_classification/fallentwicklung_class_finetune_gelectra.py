...
cwd = os.getcwd()
sample_path = os.path.expanduser('rbs_entwicklung_direkt_sample_antwort_annotiert.xlsx')
...
# sample_path = os.path.expanduser('rbs_eltern0-1000_alk_codiert_annotiert.xlsx')
...
test_data = pd.concat([test_data_label_0, test_data_label_1, test_data_label_2])
...
psych_eltern_string = [ "A: sich verbessernde Entwicklung", "B: gleichbleibende, sich nicht verbessernde Entwicklung oder uneinheitliche, unklare Entwicklung", "C: sich verschlechternde Entwicklung"]
...
id2label={
    ...
    "0": "A: sich verbessernde Entwicklung",
    "1": "B: gleichbleibende, sich nicht verbessernde Entwicklung oder uneinheitliche, unklare Entwicklung", 
    "2": "C: sich verschlechternde Entwicklung"
  }

label2id={
    
    "A: sich verbessernde Entwicklung": 0,
    "B: gleichbleibende, sich nicht verbessernde Entwicklung oder uneinheitliche, unklare Entwicklung": 1,    
    "C: sich verschlechternde Entwicklung": 2
  }, 
...
training_args = TrainingArguments(output_dir='results_gelectra_alk_finetune', 
                                  num_train_epochs=4, 
                                #   logging_steps=100, 
                                #   save_steps=100,
...
psych_eltern_string = [ "A: sich verbessernde Entwicklung", 
"B: gleichbleibende, sich nicht verbessernde Entwicklung oder uneinheitliche, unklare Entwicklung", 
"C: sich verschlechternde Entwicklung"]
...
model.save_pretrained("fallentwicklung_class_gelectra_direkt", safe_serialization=True)
tokenizer.save_pretrained("fallentwicklung_class_gelectra_direkt")
